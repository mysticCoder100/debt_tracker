    ...
    "relative w-full rounded-lg border border-neutral-200 p-4 [&>svg~*]:pl-7 [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-neutral-950 dark:border-neutral-800 dark:[&>svg]:text-neutral-50",
    {
        variants: {
            variant: {
                ...
                nonDestructive:
                    "border-teal-500/50 text-teal-500 dark:border-teal-500 [&>svg]:text-teal-500 dark:border-teal-900/50" +
                    " dark:text-teal-900 dark:dark:border-teal-900 dark:[&>svg]:text-teal-900",
            },
        },
        defaultVariants: {
            variant: "default",
